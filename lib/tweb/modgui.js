...
var _cUrl_MsgServer = '/gpro/msgserver'

function MsgServer( cType, cKey, oValues, fCallback ) {

	//var cUrl = '/gpro/msgserver'		
	
	console.log( 'MsgServer()', oValues )
		console.log( typeof oValues )
		console.log( $.type(oValues ))
	...
	$.post( _cUrl_MsgServer, oPar )		
		...
		.fail( function(data){ 
			 console.log( 'URL', _cUrl_MsgServer )
			 console.log( data )
...
function MsgTask( cKey, oValues, fCallback ) {

	return 	MsgServer( 'task', cKey, oValues, fCallback ) 
}

//----------------------------------------------------------------------------//

function MsgView( cKey, oValues, fCallback ) {

	return 	MsgServer( 'view', cKey, oValues, fCallback ) 
}
