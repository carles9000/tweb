...
function TWebBrowse( cId, aData, lInit ) {
	...
	this.ResetChanges = function( aRows_Updated ) {
		...
		if ( typeof aRows_Updated == 'object' ) {
			...
			console.log( 'CHANGES0 cUniqueId', cUniqueId )
			console.log( 'CHANGES1', aChanges )
			console.log( 'CHANGES1a', TWebBrowse.aChanges[ cId ]  )
			...
			for (i = 0; i < aRows_Updated.length; i++) {
				...
				if ( cAction != 'D' ) {
					...
					console.log( 'Busco row amb id', cIdRow )
					
					oItem = oBrowse.bootstrapTable('getRowByUniqueId', cIdRow )
					
					console.log( 'oItem actual' , oItem )
					console.log( 'Actualitzar cUniqueId ' + cUniqueId , nValue )
					
					//	Actualizo id del item 
					
						oItem[ cUniqueId ] = nValue 
						
					console.log( 'oItem con nuevo id ' , oItem )									
				...
				console.log( 'CHANGES1b', TWebBrowse.aChanges[ cId ]  )				
			
			}					
			
			console.log( 'CHANGES1c', TWebBrowse.aChanges[ cId ]  )
			console.log( 'CHANGES1 Size', Object.size( TWebBrowse.aChanges[ cId ] )  )
			if ( Object.size( TWebBrowse.aChanges[ cId ] ) == 0 ) {
				TWebBrowse.aChanges[ cId ] = new Object()
			}
			
			console.log( 'CHANGES1d', TWebBrowse.aChanges[ cId ]  )
			console.log( 'CHANGES1 Size2', Object.size( TWebBrowse.aChanges[ cId ] )  )
